...
def conectar():
    try:
        global conexao
        conexao = mysql.connector.connect(host='127.0.0.1', database='ictmanagement', password='1234', user='root')
...
def atualizar(comando):
    ...
    cursor.close()
    conexao.close()
# comando = 'UPDATE ictmanagement.management_coberturatotaln50s SET tested = tested-1 WHERE Id = 3'
...
# conectar()
# atualizar('UPDATE ictmanagement.management_coberturatotaln50s SET tested = tested-1 WHERE Id = 1')

# """se for sucessido ir pra outra url usando reverse_lazy para uma view de sucesso e ir ter um botao para voltar a pagina anterior"""